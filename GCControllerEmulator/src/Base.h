#pragma once
    ...
    #define GC_CONTROLLER_EMULATOR_PUBLIC extern "C" GC_CONTROLLER_EMULATOR_EXPORT
#else
    #define GC_CONTROLLER_EMULATOR_PUBLIC extern "C" GC_CONTROLLER_EMULATOR_IMPORT
#endif
